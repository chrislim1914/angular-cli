...
export default function () {
  ...
  return Promise.resolve()
    ...
    .then(() => expectFileMatchToExist('./dist', /global-img-relativeD\.png/))
    .then(() => expectFileMatchToExist('./dist', /component-img-relativeD\.png/))
    ...
    .then(() => expectFileToMatch('dist/main.js',
      /deploy\/component-img-relativeD\.png/))
    ...
    .then(() => expectFileToMatch('dist/main.js',
      /\/base\/component-img-relativeD\.png/))
